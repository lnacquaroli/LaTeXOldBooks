...
{\huge\color{black!70}\sffamily\bfseries}
...
\cleardoublepage
\input{02_mechanical_properties_of_solids}
\cleardoublepage
\input{03_elements_of_physical_statistics}
\cleardoublepage
\input{04_thermal_properties_of_solids}
\cleardoublepage
\input{05_the_band_theory_of_solids}
\cleardoublepage
\input{06_electrical_conductivity_of_solids}
\cleardoublepage
\input{07_magnetic_properties_of_solids}
\cleardoublepage
\input{08_contact_phenomena}
\cleardoublepage
\input{09_thermoelectric_and_galvanomagnetic_phenomena}
\cleardoublepage
\input{A_appendices}
\cleardoublepage
\input{glossary_of_symbols_and_notations}
\cleardoublepage
\input{bibliography}
\cleardoublepage
\input{other_titles}
