...
\begin{figure}[t]
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=0.95]{figures/cap_06/fig_6_1.pdf}
			\caption[]{}
			\label{fig:6_1}
		\end{center}
	\end{minipage}
	...
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=1]{figures/cap_06/fig_6_2.pdf}
			\caption[]{}
			\label{fig:6_2}
		\end{center}
	\end{minipage}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.95]{figures/cap_06/fig_6_3.pdf}
		\caption[]{}
		\label{fig:6_3}
	\end{center}
\vspace{-0.7cm}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.95]{figures/cap_06/fig_6_4.pdf}
		\caption[]{}
		\label{fig:6_4}
	\end{center}
	\vspace{-0.7cm}
...
\begin{figure}[t]
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=0.9]{figures/cap_06/fig_6_5.pdf}
			\caption[]{}
			\label{fig:6_5}
		\end{center}
	\end{minipage}
	...
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=0.9]{figures/cap_06/fig_6_6.pdf}
			\caption[]{}
			\label{fig:6_6}
		\end{center}
	\end{minipage}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.95]{figures/cap_06/fig_6_7.pdf}
		\caption[]{}
		\label{fig:6_7}
	\end{center}
	\vspace{-0.7cm}
