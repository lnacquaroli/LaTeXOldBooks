...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.95]{figures/cap_04/fig_4_1.pdf}
		\caption[]{}
		\label{fig:4_1}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.85]{figures/cap_04/fig_4_2.pdf}
		\caption[]{}
		\label{fig:4_2}
	\end{center}
\vspace{-0.2cm}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.95]{figures/cap_04/fig_4_3.pdf}
		\caption[]{}
		\label{fig:4_3}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=1]{figures/cap_04/fig_4_4.pdf}
		\caption[]{}
		\label{fig:4_4}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=1]{figures/cap_04/fig_4_5.pdf}
		\caption[]{}
		\label{fig:4_5}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=1]{figures/cap_04/fig_4_6.pdf}
		\caption[]{}
		\label{fig:4_6}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=1]{figures/cap_04/fig_4_7.pdf}
		\caption[]{}
		\label{fig:4_7}
	\end{center}
\end{figure}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=1]{figures/cap_04/fig_4_8.pdf}
		\caption[]{}
		\label{fig:4_8}
	\end{center}
\end{figure}
...
%		\begin{center}
%			\includegraphics[scale=0.84]{figures/cap_04/fig_4_9.pdf}
%			\caption[]{}
%			\label{fig:4_9}
%		\end{center}
%	\end{minipage}
...
%	\begin{minipage}[t]{0.35\linewidth}
%		\begin{center}
%			\includegraphics[scale=0.87]{figures/cap_04/fig_4_10.pdf}
%			\caption[]{}
%			\label{fig:4_10}
%		\end{center}
%	\end{minipage}
...
%		\begin{center}
%			\includegraphics[scale=0.85]{figures/cap_04/fig_4_11.pdf}
%			\caption[]{}
%			\label{fig:4_11}
%		\end{center}
%	\end{minipage}
...
\begin{figure}[t]
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=1]{figures/cap_04/fig_4_9.pdf}
			\caption[]{}
			\label{fig:4_9}
		\end{center}
	\end{minipage}
	...
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=1.03]{figures/cap_04/fig_4_10.pdf}
			\caption[]{}
			\label{fig:4_10}
		\end{center}
	\end{minipage}
...
\begin{figure}[t]
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=1]{figures/cap_04/fig_4_11.pdf}
			\caption[]{}
			\label{fig:4_11}
		\end{center}
	\end{minipage}
	...
	\begin{minipage}[t]{0.5\linewidth}
		\begin{center}
			\includegraphics[scale=1]{figures/cap_04/fig_4_12.pdf}
			\caption[]{}
			\label{fig:4_12}
		\end{center}
	\end{minipage}
