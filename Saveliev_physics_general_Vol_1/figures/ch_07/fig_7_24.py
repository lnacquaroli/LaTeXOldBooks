...
beta = 0.03
A1 = F0/m/np.sqrt((omega_0**2 - omega**2)**2 + 4.0*beta**2*omega**2)
beta = 0.1
A2 = F0/m/np.sqrt((omega_0**2 - omega**2)**2 + 4.0*beta**2*omega**2)
beta = 0.2
A3 = F0/m/np.sqrt((omega_0**2 - omega**2)**2 + 4.0*beta**2*omega**2)
beta = 0.9
A4 = F0/m/np.sqrt((omega_0**2 - omega**2)**2 + 4.0*beta**2*omega**2)
...
ax.plot(omega, A1, c=c[0], lw=lw, ls="solid")
ax.plot(omega, A2, c=c[2], lw=lw, ls="solid")
ax.plot(omega, A3, c=c[3], lw=lw, ls="solid")
ax.plot(omega, A4, c=c[4], lw=lw, ls="solid")
ax.set_xticklabels([])
ax.set_xticks([])
ax.set_yticklabels([])
ax.set_yticks([])
...
#
plt.savefig(path + r"\fig_7_24_.pdf", bbox_inches="tight")